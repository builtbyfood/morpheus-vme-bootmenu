#!/usr/bin/env python3
"""
Morpheus Task: Disable Boot Menu (BIOS)
========================================
...
print('[4/5] Patching XML...')
patched_xml = patch_xml_disable_bootmenu(xml)
...
remote_tmp = f'/tmp/{VM_DOMAIN}-bootmenu-disable-$$.xml'
...
if m:
    ...
    print('  [ok] <bootmenu> tag absent (libvirt default = disabled).')

print()
print(f'Done. Boot menu is DISABLED for "{VM_DOMAIN}".')
print('No boot menu will appear on next VM start.')
